...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0012_auto_20181029_1234'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2018, 10, 29, 13, 4, 9, 794850, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
