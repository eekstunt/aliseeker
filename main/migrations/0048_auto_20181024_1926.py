# Generated by Django 2.1 on 2018-10-24 19:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0047_auto_20181024_1903'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_button_label_en',
            field=main.models.preferences.BotButtonLabel(default='-', max_length=50, verbose_name='Кнопка вывода денег, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_button_label_ru',
            field=main.models.preferences.BotButtonLabel(default='-', max_length=50, verbose_name='Кнопка вывода денег, RU'),
        ),
