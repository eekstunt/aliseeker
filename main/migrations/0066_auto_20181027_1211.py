# Generated by Django 2.1 on 2018-10-27 12:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0065_auto_20181027_1108'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='feedback_accepted_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о принятом сообщении, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='feedback_accepted_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о принятом сообщении, RU'),
        ),
