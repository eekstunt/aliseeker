# Generated by Django 2.1 on 2018-10-30 16:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0092_auto_20181030_1557'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='alert_proposal_button_label_en',
            field=main.models.preferences.BotButtonLabel(default='-', max_length=50, verbose_name='Кнопка продолжения отслеживания, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='alert_proposal_button_label_ru',
            field=main.models.preferences.BotButtonLabel(default='-', max_length=50, verbose_name='Кнопка продолжения отслеживания, RU'),
        ),
        migrations.AddField(
            model_name='texts',
            name='alert_proposal_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Предложение о продолжении отслеживания, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='alert_proposal_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Предложение о продолжении отслеживания, RU'),
        ),
