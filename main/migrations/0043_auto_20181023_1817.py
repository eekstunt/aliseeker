# Generated by Django 2.1 on 2018-10-23 18:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(default=True, verbose_name='Англоязычные'),
        ),
        migrations.AlterField(
            model_name='post',
            name='segmentation_ru',
            field=models.BooleanField(default=True, verbose_name='Русскоязычные'),
        ),
        migrations.AlterField(
            model_name='post',
            name='segmentation_with_referrals',
            field=models.BooleanField(default=True, verbose_name='С рефералами'),
        ),
        migrations.AlterField(
            model_name='post',
            name='segmentation_without_referrals',
            field=models.BooleanField(default=True, verbose_name='Без рефералов'),
        ),
    ]
