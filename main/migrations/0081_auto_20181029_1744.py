...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0080_auto_20181029_1733'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='referral_program_min_withdrawal_amount_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о минимальной сумме для вывода, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_min_withdrawal_amount_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о минимальной сумме для вывода, RU'),
        ),
