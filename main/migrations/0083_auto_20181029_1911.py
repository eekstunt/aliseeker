# Generated by Django 2.1 on 2018-10-29 19:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0082_auto_20181029_1840'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_waiting_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение об ожидании вывода денег, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_waiting_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение об ожидании вывода денег, RU'),
        ),
