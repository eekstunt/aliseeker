...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Кнопка добавления товара, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='notifications_add_offer_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Кнопка добавления товара, RU'),
        ),
