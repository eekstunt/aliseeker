# Generated by Django 2.1 on 2018-10-29 18:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0081_auto_20181029_1744'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='referral_program_account_number_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение ввода номера кошелька, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_account_number_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение ввода номера кошелька, RU'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_payment_system_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение выбора платежной системы, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_payment_system_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение выбора платежной системы, RU'),
        ),
