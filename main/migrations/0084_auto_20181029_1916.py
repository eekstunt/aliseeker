# Generated by Django 2.1 on 2018-10-29 19:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0083_auto_20181029_1911'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_fail_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о неуспешном выводе денег, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_fail_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о неуспешном выводе денег, RU'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_success_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение об успешном выводе денег, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='referral_program_withdraw_success_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение об успешном выводе денег, RU'),
        ),
