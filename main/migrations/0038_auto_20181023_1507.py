# Generated by Django 2.1 on 2018-10-23 15:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0037_auto_20181023_1440'),
    ]

    operations = [
        migrations.AddField(
            model_name='texts',
            name='spam_protection_message_en',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о срабатывании защиты, EN'),
        ),
        migrations.AddField(
            model_name='texts',
            name='spam_protection_message_ru',
            field=main.models.preferences.BotMessage(default='-', max_length=4000, verbose_name='Сообщение о срабатывании защиты, RU'),
        ),
